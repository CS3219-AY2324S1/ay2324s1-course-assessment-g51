...
interface SignInButtonProps {
    provider: GoogleAuthProvider | FacebookAuthProvider | GithubAuthProvider | TwitterAuthProvider;
    iconImage: string;
    iconImageAlt: string;
}

const SignInButton = ({ provider, iconImage, iconImageAlt }: SignInButtonProps) => {
